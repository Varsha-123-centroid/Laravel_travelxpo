...
<head>
        ...
        <meta charset="utf-8" />
        <title>Dashboard | Travexpo</title>
...
<span class="avalpointsTxt">
    ...
    <span class="currencyTxt">
            ...
            <div class="vertical-menu">
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{route('admin.adminProfile')}}" class=" waves-effect">
							...
							<li>
								<a href="{{route('admin.setMarkup')}}" class=" waves-effect">
									<i class="ri-chat-1-line"></i>
									<span>Set Markup</span>
								</a>
							</li>
							<li>
                                <a href="{{route('admin.addAgent')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span>Agent creations</span>
                                </a>
                            </li>
						<li>
                                <a href="{{route('admin.agentList')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span>Agent creations List</span>
                                </a>
                            </li>
							<li>
                                <a href="{{route('admin.changeAdminPassword')}}" class=" waves-effect">
							...
							<li>
                                <a href="{{route('admin.approveList')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                ...
                <li>
                                <a href="{{route('admin.addAirlines')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span> Add Airlines</span>
                                </a>
                            </li>
							 <li>
                                <a href="{{route('admin.addAirport')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span> Add Airport</span>
                                </a>
                            </li>
							     <li>
                                <a href="{{route('admin.addCity')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span> Add Airport City</span>
                                </a>
                            </li>
							   <li>
                                <a href="{{route('admin.addCountry')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span> Add Country</span>
                                </a>
                            </li>
							   <li>
                                <a href="{{route('admin.dailySalesReport')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span> Daily Sales Report</span>
                                </a>
                            </li>
							<li>
                                <a href="{{route('admin.bookingReport')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span> Booking Report</span>
                                </a>
                            </li>
							<li>
                                <a href="{{route('admin.agent_recieptReport')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span> Agent Receipt Report</span>
                                </a>
                            </li>
							<li>
                                <a href="{{route('admin.Cancel')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span> Ticket Cancel</span>
                                </a>
                            </li>
							<li>
                                <a href="{{route('admin.cancelList')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span>Cancelation List</span>
                                </a>
                            </li>
				<!--	<li>
                                <a href="{{route('admin.newAgentsList')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span>New Agent Reg List</span>
                                </a>
                            </li>-->
