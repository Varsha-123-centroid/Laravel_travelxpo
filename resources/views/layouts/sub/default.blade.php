...
<head>
        ...
        <meta charset="utf-8" />
        <title>Dashboard | SubAgent</title>
            ...
            0
                        ...
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                              ...
                              <span class="d-none d-xl-inline-block ms-1">SubAgent</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item text-danger" href="{{ route('sub.logout') }}"><i class="ri-shut-down-line align-middle me-1 text-danger"></i> Logout</a>
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{route('sub.dashboard')}}" class="waves-effect">
                           ...
                           <li>
                                <a href="{{route('sub.adminProfile')}}" class=" waves-effect">
                                    <i class="ri-calendar-2-line"></i>
                                    <span>Edit Profile</span>
                                </a>
                            </li>
<li>
								<a href="{{route('sub.subMarkupList')}}" class=" waves-effect">
									<i class="ri-chat-1-line"></i>
									<span>Set Markup List</span>
								</a>
							</li>
							<li>
                                <a href="{{route('sub.operationStaff')}}" class=" waves-effect">
						...
						<li>
							...
							<li>
                                <a href="{{route('sub.changeAdminPassword')}}" class=" waves-effect">
                                    <i class="ri-store-2-line"></i>
                                    <span>Change Password</span>
                                </a>
                            </li>
							<li>
                                <a href="{{route('sub.makePayment')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span>Supplier Payment</span>
                                </a>
                            </li>
							 <li>
                                <a href="{{route('sub.dailySalesReport')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                                    <span> Daily Sales Report</span>
                                </a>
                            </li>
						<li>
                                <a href="{{route('sub.bookingReport')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
                              ...
                              <li>
                                <a href="{{route('sub.Cancel')}}" class=" waves-effect">
                                    <i class="ri-artboard-2-line"></i>
