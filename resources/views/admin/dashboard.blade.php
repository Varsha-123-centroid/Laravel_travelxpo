...
@section('content')
                    ...
                    <div class="container-fluid">
						...
						<div class="edit_profileSec">
							<div class="editProfileForm">
								...
								<form method="POST" action="{{ route('admin.search_Passengerslist') }}">
								@csrf
									<div class="clearDiv row">
										<div class="col-md-4">
		...
		<div class="edit_profileSec">
							...
							<div class=" table-responsive ">
								<table id="datatable" class="table scrollmenu table-bordered  nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
									<thead>
   ...
   <button class="edit-btn btn btn-primary float-end" data-toggle="modal" data-target="#editModal" data-pnr="{{$val->PNR}}" data-booking-id="{{$val->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
    ...
    <button class="save-btn" style="display: none;">Save</button></td>
						...
						<div class="edit_profileSec">
							<div class="editProfileForm">
								<div class="clearDiv row">
									<div class="col-md-4">
									<form method="post">
										<a class="submitebtn btn btn-success" href="#" target="_blank"> ... </a>
									</form>
									</div>
								</div>
							</div>
...
<div class="modal fade" id="searchdModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
			<input type="hidden" class="form-control" id="editPassengerId">
                <div class="form-group">
...
<link href="https://cdn.jsdelivr.net/npm/slim-select/dist/slimselect.min.css" rel="stylesheet">
<script>
...
    });
      ...
      function downloadTicket(bookingId, pnr) {
        $.ajax({
            ...
            url: "{{ route('admin.authenticateTicket') }}",
            type: 'POST',
            dataType: 'json',
...
function printTicket(modal) {
    ...
    $.ajax({
        url: "{{ route('admin.generatePDFInvoice') }}",
        type: 'POST',
        headers: {
