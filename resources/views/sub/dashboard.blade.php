                    ...
                    <div class="container-fluid">
						...
						<div class="edit_profileSec">
							<div class="editProfileForm">
								...
								<form method="POST" action="{{ route('sub.search_Passengerslist') }}">
								@csrf
									<div class="clearDiv row">
										<div class="col-md-4">
...
    });
      ...
      function downloadTicket(bookingId, pnr) {
        $.ajax({
            ...
            url: "{{ route('sub.authenticateTicket') }}",
            type: 'POST',
            dataType: 'json',
...
$(document).ready(function() {
    ...
    $.ajax({
        url: "{{ route('sub.generatePDFInvoice') }}",
        type: 'POST',
        headers: {
