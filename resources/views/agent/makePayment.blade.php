@if (Auth::check())
   ...
   @else
        @php
            ...
            $paymentSave = route('sub.paymentSave');
        @endphp
								...
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-group">
								 ...
								 <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-group">
									...
									<div class="input_icon">
										<select class="form-control" name="supplier" id="supplier">
											<option value="">Select</option>
										    <option value="1">Travelexpo</option>
								...
								<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 form-group">
								    <div class="clearDiv row">
										...
										<!--<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
											...
											<input type="hidden" name="exchange" id="exchange" value="" title="Last Name" placeholder="" class="form-control" autocomplete="none" value="0">
										<!--</div>-->
