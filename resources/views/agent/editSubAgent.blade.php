...
@section('content')
  ...
  <input type="email" name="txt_agency_email" id="txt_agency_email" value="{{$agentData->company_email}}"  class="form-control txt_iata_number itaDisabled" title="IATA number" placeholder="Company Email" autocomplete="none" oninput="validateEmail('txt_agency_email', 'agency-email-error')">
  <span id="agency-email-error" class="error-message"></span>
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-group">
										...
										<input type="text" name="txt_agency_lname" id="txt_agency_lname" value="{{$agentData->last_name}}" class="form-control txt_iata_number itaDisabled" title="IATA number" placeholder="Last Name" autocomplete="none">
									</div>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-group">
  ...
  <img src="{{asset('uploads/agent/'.$agentData->profile_image) }}" download alt="Agent Image" style="width: 180px; height: 180px;">
    ...
    @endforeach
									...
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-group">
										...
										<input type="text" name="txt_pincode" id="txt_pincode" class="form-control" value="{{$agentData->postal_code}}"  title="Pincode/Zipcode" placeholder="Pincode/Zipcode"  autocomplete="none">
									</div>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-group">
										<div class="approvalRadioBtn">
											<label>IATA Registration Number</label>
										<input type="text" name="rad_iata_status" id="rad_iata_status" class="form-control" value="{{$agentData->iata_status}}"  title="IATA Registration Number" placeholder="IATA Registration Number"  autocomplete="none">
										</div>
									</div>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-group">
		                                   <div class="contactDlts row">
		                                     ...
		                                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		                                         <label>Phone Number<span class="mandatory">*</span></label>
		                                         	<input type="text" name="txt_phone" value="{{$agentData->phonenumber}}"  title="Phone Number" placeholder="Phone Number With Code" class="form-control edit_phoneNumber phNumber" autocomplete="none">
											</div>
										</div>
									</div>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-group">
	                                       <div class="contactDlts row">
	                                         ...
	                                         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                             <label>Mobile Number<span class="mandatory">*</span></label>
	                                             	<input type="text" name="txt_mobile" value="{{$agentData->mobile_number}}"  title="Mobile Number" placeholder="Mobile Number with code" class="form-control edit_phoneNumber phNumber"  autocomplete="none">
	                                         </div>
	                                    </div>
									</div>
	                                     ...
	                                     <div class="contactDlts row">
	                                          ...
	                                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                             <label>Fax Number</label>
	                                             	<input type="text" name="txt_fax" value="{{$agentData->fax_number}}" title="Fax No." placeholder="Fax Number with code" class="form-control edit_phoneNumber phNumber" autocomplete="none">
	                                             </div>
	                                      </div>
									</div>
									<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-group">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
										...
										<div class="row">
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
												<label>Name</label>
												<input type="text" name="txt_acc_name" value="{{$agentData->agency_account_name}}" title="Name" placeholder="Name" class="form-control" autocomplete="none">
											</div>
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
  <label>Email</label>
  <input type="email" name="txt_acc_email" id="txt_acc_email" value="{{$agentData->agency_account_email}}"  title="Email Address" placeholder="Email Address" class="form-control" autocomplete="none" oninput="validateEmail('txt_acc_email', 'acc-email-error')">
  <span id="acc-email-error" class="error-message"></span>
</div>

											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
												<label>Phone Number</label>
												<input type="text" name="txt_acc_ph" value="{{$agentData->agency_account_phoneno}}"  title="Email Address" placeholder="Phone Number" class="form-control" autocomplete="none">
											</div>
										</div>
									</div>
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
										...
										<div class="row">
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
												<label>Name</label>
												<input type="text" name="txt_res_name" value="{{$agentData->agency_reservation_name}}"  title="Name" placeholder="Name" class="form-control" autocomplete="none">
											</div>
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
  <label>Email</label>
  <input type="email" name="txt_res_email" id="txt_res_email" value="{{$agentData->agency_reservation_email}}"  title="Email Address" placeholder="Email Address" class="form-control" autocomplete="none" oninput="validateEmail('txt_res_email', 'res-email-error')">
  <span id="res-email-error" class="error-message"></span>
											...
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
												<label>Phone Number</label>
												<input type="text" name="txt_res_ph" value="{{$agentData->agency_reservation_phoneno}}"  title="Email Address" placeholder="Phone Number" class="form-control" autocomplete="none">
											</div>
										</div>
									</div>
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
										...
										<div class="row">
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
												<label>Name</label>
												<input type="text" name="txt_mgt_name" value="{{$agentData->agency_mgt_name}}"  title="Name" placeholder="Name" class="form-control" autocomplete="none">
											</div>
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
  <label>Email</label>
  <input type="email" name="txt_mgt_email" id="txt_mgt_email" value="{{$agentData->agency_mgt_email}}"  title="Email Address" placeholder="Email Address" class="form-control" autocomplete="none" oninput="validateEmail('txt_mgt_email', 'mgt-email-error')">
  <span id="mgt-email-error" class="error-message"></span>
</div>
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
												<label>Phone Number</label>
												<input type="text" name="txt_mgt_ph" value="{{$agentData->agency_mgt_ph}}"  title="Email Address" placeholder="Phone Number" class="form-control" autocomplete="none">
											</div>
										</div>
									</div>
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
    ...
    @endforeach
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
										...
										<input type="text" name="txt_credit" id="txt_credit" class="form-control" value="{{$agentData->credit_limit}}"  title="Credit Limit" placeholder=""  autocomplete="none">
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
										<label>Temp Credit Limit</label>
										<input type="text" name="temp_credit" id="temp_credit" class="form-control" value="{{$agentData->temp_credit_limit}}"  title="Credit Limit" placeholder=""  autocomplete="none">
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
										<div class="approvalRadioBtn">
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
										...
										<div class="input_icon">
											<input type="text" name="txt_branch" value="{{$branchData->branch_name}}"  title="Name" placeholder="Enter Branch" class="form-control" autocomplete="none">
											<span class="editProfileSelect"><i class="" aria-hidden="true"></i></span>
										</div>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
										...
										<div class="input_icon">
										<input type="text" name="txt_sales_mgr" value="{{$agentData->sales_manager}}"  title="Name" placeholder="Enter Branch" class="form-control" autocomplete="none">
											<span class="editProfileSelect"><i class="" aria-hidden="true"></i></span>
										</div>
									</div>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-group">
										...
										<div class="input_icon">
										<input type="text" name="txt_consultant" value="{{$agentData->	consultant}}"  title="Name" placeholder="Enter Branch" class="form-control" autocomplete="none">
											<span class="editProfileSelect"><i class="" aria-hidden="true"></i></span>
										</div>
									</div>
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 form-group">
        <div class="addStaff">
            <div class="checkbox checkbox-inline">
                <input id="allowCancel" type="checkbox" name="rights[]" value="multi_currency_search" autocomplete="none" @if('yes'==$agentRightsData[0]->right_acess) checked @endif>
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 form-group">
        <div class="addStaff">
            <div class="checkbox checkbox-inline">
                <input type="checkbox" id="can_cancel" name="rights[]" value="allow_create_quotations" autocomplete="none" @if('yes'==$agentRightsData[1]->right_acess) checked @endif>
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-group">
        <div class="addStaff">
            <div class="checkbox checkbox-inline">
                <input type="checkbox" id="allow_non_refundable" name="rights[]" value="allow_non_refundable_bookings" autocomplete="none" @if('yes'==$agentRightsData[2]->right_acess) checked @endif>
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 form-group">
        <div class="addStaff">
            <div class="checkbox checkbox-inline">
                <input type="checkbox" id="allow_voucher_bookings" name="rights[]" value="allow_voucher_bookings" autocomplete="none" @if('yes'==$agentRightsData[3]->right_acess) checked @endif>
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 form-group">
        <div class="addStaff">
            <div class="checkbox checkbox-inline">
                <input type="checkbox" id="make_bookings" name="rights[]" value="make_bookings" autocomplete="none" @if('yes'==$agentRightsData[4]->right_acess) checked @endif>
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 form-group">
        <div class="addStaff">
            <div class="checkbox checkbox-inline">
                <input type="checkbox" id="debug_mode" name="rights[]" value="debug_mode" autocomplete="none" @if('yes'==$agentRightsData[5]->right_acess) checked @endif>
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 form-group">
        <div class="addStaff">
            <div class="checkbox checkbox-inline">
                <input type="checkbox" id="flights_allow_ticketing" name="rights[]" value="flights_allow_ticketing" autocomplete="none" @if('yes'==$agentRightsData[6]->right_acess) checked @endif>
...
<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 form-group">
    <div class="addStaff">
        <div class="checkbox checkbox-inline">
            <input type="checkbox" id="web_services" name="rights[]" value="web_services" autocomplete="none" @if('yes'==$agentRightsData[7]->right_acess) checked @endif>
...
if (category === "") {
  ...
  return;
        ...
        $.ajax({
            ...
            url: "{{ route('agent.subAgentUpdate') }}",
            data: formData,
            dataType: 'json',
